...
export const verticalMenuItems = [
  ...
  new Menu(3, "Boutiques", "/boutiques", null, "store", null, true, 0),
  new Menu(4, "List Boutiques", "/boutiques", null, "store", null, false, 3),
  new Menu(5, "Add Boutique", "/boutiqueAdd", null, "add", null, false, 3),
  new Menu(6, "Villes", "/villes", null, "location_city", null, true, 0),
  new Menu(7, "Villes", "/villes", null, "location_city", null, false, 6),
  new Menu(8, "Add ville", "/villeAdd", null, "add", null, false, 5),
  new Menu(9, "Zones", "/zones", null, "place", null, true, 0),
  new Menu(10, "Zones", "/zones", null, "place", null, false, 9),
  new Menu(11, "Add zone", "/zoneAdd", null, "add", null, false, 7),
  new Menu(
    12,
    "Questionnaire",
    "/questionnaires",
  ...
  new Menu(16, "par Question", null, null, "multiline_chart", null, true, 15),
  new Menu(
    17,
    "Bar Charts",
    "/charts/barparquestion",
    null,
    "insert_chart",
    null,
    false,
  ...
  new Menu(14, "Pie Charts", "/charts/pie", null, "pie_chart", null, false, 15),
  new Menu(
    18,
    "Line Charts",
    "/charts/line",
